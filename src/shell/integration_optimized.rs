//! Optimized shell integration scripts using zoxide patterns

/// PowerShell integration script optimized with global scope
pub const POWERSHELL_INTEGRATION_OPTIMIZED: &str = r#"
# =============================================================================
#
